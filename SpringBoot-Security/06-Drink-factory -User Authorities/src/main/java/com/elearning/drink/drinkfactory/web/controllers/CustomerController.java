...
import com.elearning.drink.drinkfactory.security.perms.CustomerCreatePermission;
import com.elearning.drink.drinkfactory.security.perms.CustomerReadPermission;
import com.elearning.drink.drinkfactory.security.perms.CustomerUpdatePermission;
...
public class CustomerController {
    ...
    //@Secured({"ROLE_ADMIN", "ROLE_CUSTOMER"}) ->  goes in hand with securedEnabled = true
    ...
    public String processUpdationForm(@Valid Customer customer, BindingResult result) {
        if (result.hasErrors()) {
            return "drinks/createOrUpdateCustomer";
        } else {
            //ToDO: Add Service
