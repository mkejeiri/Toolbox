...
public class BeerOrderManagerIT {
    ...
    void testAllocatedToCancel() throws JsonProcessingException {
        ...
        DeallocateOrderRequested deallocateOrderRequested =
                (DeallocateOrderRequested) jmsTemplate.receiveAndConvert(JmsConfig.DEALLOCATE_ORDER_QUEUE);

        assertNotNull(deallocateOrderRequested);
        assertThat(deallocateOrderRequested.getBeerOrderDto().getId()).isEqualTo(savedBeerOrder.getId());
    }
