...
## [Dockerised activemq](https://github.com/vromero/activemq-artemis-docker)

`docker run -it --rm  -e ARTEMIS_USERNAME=username -e ARTEMIS_PASSWORD=password  -p 8161:8161 -p 61616:61616 vromero/activemq-artemis`

go to `http://0.0.0.0:8161/console/` and log in as `username/password`
...
**the Spring abstraction of a message and that also works within the Spring Framework**
