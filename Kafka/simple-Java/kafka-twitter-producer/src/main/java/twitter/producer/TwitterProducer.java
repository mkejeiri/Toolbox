...
public class TwitterProducer {
    ...
    //TODO: read your own credentials from secrets of your machine/container secrets - don't share them with anyone.
    String consumerKey = "";
    ...
    public void run() {
        ...
        // add a shutdown hook : using lambda
        ...
        //Or alternatively, add a shutdown hook
        /*
        ...
        while (!client.isDone()) {
            ...
            if (msg != null) {
                ...
                producer.send(new ProducerRecord<>("twitter_tweets", null, msg), (recordMetadata, e) -> {
                 ...
                 Future<RecordMetadata> send = producer.send(new ProducerRecord<>("twitter_tweets", null, msg), (recordMetadata, e) -> {
                    if (e != null) {
                        logger.error("Something bad happened", e);
                    }
                });
                ...
                producer.send(new ProducerRecord<>("twitter_tweets", null, msg),
                        this::onCompletion);
                 //onCompletion need to be created!
